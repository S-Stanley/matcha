...
```bash
curl -X PATCH http://127.0.0.1:5000/users -d email=4 -d firstname=firstname -d lastname=lastname -d bio=bio -d gender=MALE -d preference=FEMALE -d username=username -d city=Paris -d age=25 -H token:5f737066-f767-4235-bbde-8765a7edff18
```
